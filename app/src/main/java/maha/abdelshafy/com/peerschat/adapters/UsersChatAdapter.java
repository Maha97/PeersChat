...
import maha.abdelshafy.com.peerschat.ui.ChatActivity;
...
public class UsersChatAdapter extends RecyclerView.Adapter<UsersChatAdapter.ViewHolderUsers> {
    ...
    public ViewHolderUsers onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolderUsers(mContext, LayoutInflater.from(parent.getContext()).inflate(R.layout.item_user_profile, parent, false));
    }
    ...
    public void onBindViewHolder(ViewHolderUsers holder, int position) {
        ...
        int userAvatarId = ChatHelper.getDrawableAvatarId(fireChatUser.getAvatar_id());
